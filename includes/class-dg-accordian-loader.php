...
class Dg_Accordian_Loader {
    ...
    function dg_template_part($templateFile){

        if ( $overridden_template = locate_template( DIRECTORY_SEPARATOR.'dg-accordian'.DIRECTORY_SEPARATOR.$templateFile ) ) {
